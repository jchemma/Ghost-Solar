...
public class LookUpClassesToAdd {
	...
	public void display() {
		...
		ObservableList<String> subItems = FXCollections.observableArrayList("ACCOUNTING", "BIOLOGY", "CHEMISTRY",
				...
				"INTERIOR DESIGN", "JOURNALISM", "kINESIOLOGY", "LANGUAGE ARTS EDUCATION", "MATHEMATICS", "NURSING",
				"PERSPECTIVE", "REAL ESTATE", "SPANISH", "TAXATION", "WOMEN'S GENDER & SEXUALITY STU");
